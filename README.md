...
enrichment continues. Provider circuits persist across batches and recycled
workers in `analysis/logs/external-provider-cooldowns.json`, then half-open with
