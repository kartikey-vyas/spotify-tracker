...
Package manager is **pnpm** (Node >= 22). Scripts run under `tsx`.
...
This repo has three TypeScript environments with different module systems and env access. Code does not cross between them.
